...
class txt {
  ...
  static TextStyle snackss(dynamic color) {
    return TextStyle(
      height: 0,
      color: color,
      fontSize: 16,
  ...
  static TextStyle snackss1(dynamic color) {
    return TextStyle(
      height: 0,
      color: color,
      fontSize: 26,
